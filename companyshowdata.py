...
def compshow():
    ...
    b.place(x=150,y=150)
    b1=Label(t,width=25,font=("Comic Sans MS", 14,"bold"),fg='royalblue',bg='pink3',bd=4)
    ...
    bt1=Button(t,text='First',bd=5,font=1,bg='light slate gray',fg='spring green',command=first)
    bt1.place(x=150,y=650)
    
    bt2=Button(t,text='Next',bd=5,font=1,bg='light slate gray',fg='spring green',command=Next)
    bt2.place(x=300,y=650)
    
    bt3=Button(t,text='Previous',font=1,bd=5,bg='light slate gray',fg='spring green',command=Prev)
    bt3.place(x=475,y=650)
    
    bt4=Button(t,text='Last',bd=5,font=1,bg='light slate gray',fg='spring green',command=last)
    bt4.place(x=650,y=650)
    fillcompdata()

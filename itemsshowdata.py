...
def itemsshow():
    ...
    b.place(x=150,y=150)
    b1=Label(t,width=25,font=("Comic Sans MS", 14,"bold"),fg='royalblue',bg='MistyRose2',bd=4)
    ...
    bt1=Button(t,text='First',bd=3,bg='gray',font=1,fg='cyan',command=first)
    bt1.place(x=150,y=680)
    
    bt2=Button(t,text='Next',bd=3,bg='gray',font=1,fg='cyan',command=Next)
    bt2.place(x=300,y=680)
    
    bt3=Button(t,text='Previous',bd=3,bg='gray',font=1,fg='cyan',command=Prev)
    bt3.place(x=475,y=680)
    
    bt4=Button(t,text='Last',bd=3,bg='gray',font=1,fg='cyan',command=last)
    bt4.place(x=650,y=680)
    filldata()
